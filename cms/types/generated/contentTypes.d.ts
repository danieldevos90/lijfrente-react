...
export interface ApiLeadLead extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    use_of_funds: Schema.Attribute.Enumeration<
      [
        'werkkapitaal',
        'voorraden_en_crediteuren',
        'meer_personeel',
        'voertuigen_en_machines',
        'inventaris_en_software',
        'bedrijfspand_financieren',
        'herfinanciering',
...
export interface ApiTokenSetTokenSet extends Struct.CollectionTypeSchema {
  collectionName: 'token_sets';
  info: {
    displayName: 'Token Set';
    pluralName: 'token-sets';
    singularName: 'token-set';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::token-set.token-set'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    siteId: Schema.Attribute.String & Schema.Attribute.Required;
    typography: Schema.Attribute.JSON;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
